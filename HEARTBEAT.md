...
### 4c. Мониторинг падающих cron-задач ⚠️
- **Раз в 3 дня:** проверяю active-tasks.md на задачи со статусом "Unknown target" или аналогичными ошибками
- **Арт (@art_observer):** если канал ещё не создан через 3 дня → мягко напомнить Александру (не давить)
- **Правило:** падающий cron ≠ "решится само". Всегда фиксировать в active-tasks.md с датой следующего напоминания
- **Шаблон напоминания:** "🎨 Арт-проект ждёт канала @art_observer уже N дней. Создать сегодня?"
